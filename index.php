...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-160400489-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-160400489-1');
    </script>
...
Contacto</span>
  ...
  <table border="0" align="center" width="50%">
    <tr>
      <td ><div align="center"><img src="imagenes/contacto/mail.png" width="78" height="78"></div></td>
      <td >&nbsp;</td>
      <td ><div align="center"><img src="imagenes/contacto/fb.png" width="78" height="78"></div></td>
    </tr>
    <tr>
